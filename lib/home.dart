  ...
  Future<void> _initializeAll() async {
    ...
    try {
      ...
      final loaded = await _llama.loadModel(
        '/Users/skywar56/Documents/Flutter/quiz_wrapper/assets/OLMO_1B.gguf',
      ...
      // Context
      final contextCreated = await _llama.createContext(config: const ContextConfig(nCtx: 2048, nThreads: 4));
...
''';
  ...
  SamplerConfig _getSamplerConfig() {
    ...
    return baseConfig.copyWith(
      maxTokens: 3072,
      stopStrings: [
        // "<end_of_turn>", // Gemma's actual stop token
        // "<eos>",
      ],
    );
  }
